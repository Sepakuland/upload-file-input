...
var _ImgPreview = _interopRequireDefault(require("../src/ImgPreview"));
...
function UploadFile(_ref) {
  ...
  function addFiles(file) {
    setFileList(
      [].concat(_toConsumableArray(fileList), _toConsumableArray(file))
    );
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        {
          className:
            "file-uploader d-flex align-items-center justify-content-center",
        },
        /*#__PURE__*/ React.createElement(
          "label",
          {
            htmlFor: "uploadFile",
            className:
              "ant-upload d-flex align-items-center justify-content-center ",
          },
        ...
        : fileList.map(function (item, index) {
            return /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                item.type === "image/png"
                  ? /*#__PURE__*/ React.createElement(_ImgPreview["default"], {
                      file: item,
                      alt: "pic",
                    })
                  : /*#__PURE__*/ React.createElement(
